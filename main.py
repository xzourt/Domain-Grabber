...
def Banner():
    ...
    __banner__ = f"""{Fore.LIGHTMAGENTA_EX}
·▄▄▄▄        • ▌ ▄ ·.  ▄▄▄· ▪   ▐ ▄      ▄▄ • ▄▄▄   ▄▄▄· ▄▄▄▄· ▄▄▄▄· ▄▄▄ .▄▄▄  
██▪ ██ ▪     ·██ ▐███▪▐█ ▀█ ██ •█▌▐█    ▐█ ▀ ▪▀▄ █·▐█ ▀█ ▐█ ▀█▪▐█ ▀█▪▀▄.▀·▀▄ █·
▐█· ▐█▌ ▄█▀▄ ▐█ ▌▐▌▐█·▄█▀▀█ ▐█·▐█▐▐▌    ▄█ ▀█▄▐▀▀▄ ▄█▀▀█ ▐█▀▀█▄▐█▀▀█▄▐▀▀▪▄▐▀▀▄ 
██. ██ ▐█▌.▐▌██ ██▌▐█▌▐█ ▪▐▌▐█▌██▐█▌    ▐█▄▪▐█▐█•█▌▐█ ▪▐▌██▄▪▐███▄▪▐█▐█▄▄▌▐█•█▌
...
def Menu():
    Banner()
    menus = f"""
{Fore.LIGHTGREEN_EX}[{Fore.WHITE}1{Fore.LIGHTGREEN_EX}] {Fore.WHITE}Grabber By Date
{Fore.LIGHTGREEN_EX}[{Fore.WHITE}2{Fore.LIGHTGREEN_EX}] {Fore.WHITE}Grabber By KeyWord
{Fore.LIGHTGREEN_EX}[{Fore.WHITE}3{Fore.LIGHTGREEN_EX}] {Fore.WHITE}Grabber By TLD (azstats.org)
{Fore.LIGHTGREEN_EX}[{Fore.WHITE}4{Fore.LIGHTGREEN_EX}] {Fore.WHITE}Grabber By TLD (pagesinventory.com)
{Fore.LIGHTGREEN_EX}[{Fore.WHITE}5{Fore.LIGHTGREEN_EX}] {Fore.WHITE}Grabber By TLD (topsitessearch.com)
{Fore.LIGHTGREEN_EX}[{Fore.WHITE}6{Fore.LIGHTGREEN_EX}] {Fore.WHITE}Grabber Domain Random (www.topmillion.net)\n"""
    print(menus)
    choose = int(input(f"{Fore.LIGHTGREEN_EX}[{Fore.WHITE}?{Fore.LIGHTGREEN_EX}] {Fore.WHITE}Choose : "))

    if choose == 1:
        CubDomain()
    elif choose == 2:
        input_list = [ j.strip("\n\r") for j in open(input(f"{Fore.LIGHTGREEN_EX}[{Fore.WHITE}?{Fore.LIGHTGREEN_EX}] {Fore.WHITE}KeyWord List : "), "r", encoding="utf-8").readlines() ]

        for x in input_list:
            GrabberByKw(x)
    elif choose == 3:
        inp_tld = input(f"{Fore.LIGHTGREEN_EX}[{Fore.WHITE}?{Fore.LIGHTGREEN_EX}] {Fore.WHITE}TLD Domain (ex: com) : ")
        ...
        inp_tld = input(f"{Fore.LIGHTGREEN_EX}[{Fore.WHITE}?{Fore.LIGHTGREEN_EX}] {Fore.WHITE}TLD Domain (ex: com) : ")
        inp_page = int(input(f"{Fore.LIGHTGREEN_EX}[{Fore.WHITE}?{Fore.LIGHTGREEN_EX}] {Fore.WHITE}Total Page (ex: 100) : "))
        ...
        exit(f"{Fore.LIGHTGREEN_EX}[{Fore.WHITE}!{Fore.LIGHTGREEN_EX}] {Fore.LIGHTYELLOW_EX}Aborted.")
...
def CubDomain():
    ...
    date1 = datetime.strptime(input(f"{Fore.LIGHTGREEN_EX}[{Fore.WHITE}?{Fore.LIGHTGREEN_EX}] {Fore.WHITE}From Date (ex: YYYY-mm-dd) : "), "%Y-%m-%d")
    date2 = datetime.strptime(input(f"{Fore.LIGHTGREEN_EX}[{Fore.WHITE}?{Fore.LIGHTGREEN_EX}] {Fore.WHITE}To Date (ex: YYYY-mm-dd) : "), "%Y-%m-%d")
...
def GrabberByKw(kw):
    ...
    if len(all_domain) != 0:
        ...
        print(req)
        sys.stdout.write(f"\n{Fore.WHITE}---> Keyword : {Fore.LIGHTBLUE_EX}{kw} {Fore.WHITE}-- {Fore.LIGHTGREEN_EX}Bad Keyword")
